          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                ...
                <Link
                  href="/dashboard"
                  className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-blue-500 bg-white border border-blue-200 hover:bg-blue-50 rounded-full shadow-sm hover:shadow transition-all duration-200 hover:-translate-y-0.5 cursor-pointer"
                >
                  Launch App Demo
                </Link>
              </div>
                ...
                <div className="relative z-10 space-y-6 flex-1 flex flex-col justify-between">
                  ...
                  <div className="p-4 rounded-2xl bg-blue-50/50 border border-blue-100/60 text-xs flex flex-col gap-2">
                    ...
                    <p className="text-slate-500 leading-relaxed">
                      &ldquo;Grandfather&apos;s sleep efficiency decreased slightly (7%) over the last 10 days alongside a mild vital deviation. Recommend scheduling a routine GP consultation.&rdquo;
                    </p>
                  </div>
