          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="text-slate-500 text-sm md:text-base leading-relaxed space-y-4">
                <p>
                  In 2025, our founder watched a close family member suffer a severe cardiovascular emergency. The hospital cardiologists explained that the patient's system had been sending subtle warning signals—changes in sleep efficiency, resting heart rate spikes, and minor fluid retention—for over three weeks. Yet, these signals went completely unmeasured.
                </p>
                <p>
                  That crisis wasn't a sudden, unpreventable event; it was a failure of preventive awareness. Warning signs were missed because caregivers lacked simple tools to monitor daily trends and connect them with clinical expertise.
                </p>
                <p>
                  SUMINO was founded to ensure that no family has to look back and say, <strong className="text-slate-700">"We wish we had known sooner."</strong> We believe that by bringing actionable health indicators directly into the household, we can prevent crises before they happen.
                </p>
              </div>
            </div>
