      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-slate-500 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
            &ldquo;We believe that AI in healthcare should serve as a supportive context builder, not a diagnostic black-box. Every advisory warning generated by SUMINO is transparent, explainable, and linked directly to peer-reviewed clinical guidelines, keeping your general physician in complete clinical control.&rdquo;
          </p>
          <div className="pt-4">
            <Link
              href="/waitlist"
